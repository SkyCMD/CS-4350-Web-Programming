...
export class AppComponent {
  ...
  @ViewChild('inpuMessage', {static: true}) public inputMessage: ElementRef;
  ...
  public log(message:string, shouldPrepend?: boolean){
    const msg = {isLog: true, } as ISocketMessage;
  ...
  private setUpListeners(){
    this.io.on(SocketEvent.Login, (data: ISocketMessage) =>{
